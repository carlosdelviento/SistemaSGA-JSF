...
public class TextExporter extends DataTableExporter {
	...
	@Override
	protected void doExport(FacesContext context, DataTable table, ExportConfiguration config, int index)
			throws IOException {
	...
	protected String getColumnTag(UIColumn column) {
		String headerText = (column.getExportHeaderValue() != null) ? column.getExportHeaderValue()
	...
	protected void configureResponse(ExternalContext externalContext, String filename) {
		...
		externalContext.setResponseHeader("Content-disposition",
				ComponentUtils.createContentDisposition("attachment", filename + ".txt"));
